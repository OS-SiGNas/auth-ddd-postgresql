import { BadRequestException400, ForbiddenException403 } from "#Domain";

import type { ISession, ISessionHandler, ITokenHandler, ITokenPayload } from "#Domain";
...
type GetSingleton = (d: Dependencies) => Readonly<_SessionHandler>;

export class _SessionHandler implements ISessionHandler {
	static #instance?: _SessionHandler;
	static readonly getInstance: GetSingleton = (d) => (this.#instance ??= new _SessionHandler(d));
