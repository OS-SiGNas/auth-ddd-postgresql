...
export interface IAuthBusiness {
	...
	readonly accountActivation: BusinessHandler<AccountActivationRequest["params"], boolean>;
	readonly activateAccount: BusinessHandler<ActivateAccountRequest["body"], boolean>;
